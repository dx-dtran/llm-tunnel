# Gemma 4 31B - gpt-fast generation script
...
def main(
    ...
    checkpoint_path: Path = Path(
        "checkpoints/google/gemma-4-31B-it/model.pth"
    ),
    compile: bool = True,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Gemma 4 31B text generation.")
